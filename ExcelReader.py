...
df = pd.DataFrame(data, columns = ['Month', 'Year', 'Local_ID',
                                   ...
                                   'Gender','Birthday','Age','fse_ise_k_ise',
                                   ...
                                   'org_English','org_Code_GERP',	
                                   'org_Name_GERP','org_Code_RHEV',	
...
cursor.execute('''CREATE TABLE headCount ([Month] INT, [Year] INT, LocalID INT, Global_ID VARCHAR(50), 
                ...
                Age int, fse_ise_k_ise VARCHAR(50),
                ...
                OrgEnglish VARCHAR(50), OrgCodeGerp int, ORGNameGERP VARCHAR(50), 
                ORGCodeRHEV VARCHAR(50), ORGNameRHEV NVARCHAR(50), [Location] NVARCHAR(50), Manager NVARCHAR(50), Assistant NVARCHAR(50),
